...
COL = 20 #指定拼接图片的列数
ROW = 20 #指定拼接图片的行数
UNIT_HEIGHT_SIZE = 500 #图片高度
UNIT_WIDTH_SIZE = 500 #图片宽度
PATH = "/home/xdt/disk/gitee/picture_paste/new/" #需要拼接的图片所在的路径
NAME = "/home/xdt/disk/gitee/picture_paste/image1-new" #拼接出的图片保存的名字
...
def concat_images(image_names, name, path):
    ...
    target.save(name + '.jpg', quality=SAVE_QUALITY) #成品图保存
